...
import com.ushahidi.android.data.api.heimdalldroid.grants.OAuth2Grant;
...
public class OAuth2AccessTokenManager<TAccessToken extends OAuth2AccessToken> {
     ...
     * expires_in field.
     *
     * @param refreshAccessTokenGrant The refresh grant that will be used if the access token is
     *                                expired.
     * @return - An Observable emitting an unexpired access token.
     */
    public Observable<TAccessToken> getValidAccessToken(
            final OAuth2RefreshAccessTokenGrant<TAccessToken> refreshAccessTokenGrant) {
