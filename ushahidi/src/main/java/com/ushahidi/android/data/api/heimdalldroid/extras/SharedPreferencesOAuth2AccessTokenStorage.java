package com.ushahidi.android.data.api.heimdalldroid.extras;
 ...
 */
public class SharedPreferencesOAuth2AccessTokenStorage<TAccessToken extends OAuth2AccessToken>
        implements OAuth2AccessTokenStorage<TAccessToken> {
     ...
     */
    public SharedPreferencesOAuth2AccessTokenStorage(SharedPreferences sharedPreferences,
            Class tokenClass) {
        super();
