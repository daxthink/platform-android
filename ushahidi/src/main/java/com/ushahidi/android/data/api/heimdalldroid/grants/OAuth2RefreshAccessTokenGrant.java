...
/**
 * Class representing the Refreshing Access Token Grant as described in
 * https://tools.ietf.org/html/rfc6749#section-6.
 *
 * @param <TAccessToken> The access token type.
 */
public abstract class OAuth2RefreshAccessTokenGrant<TAccessToken extends OAuth2AccessToken>
        implements
