 ...
 */
public abstract class OAuth2AuthorizationCodeGrant<TAccessToken extends OAuth2AccessToken>
        implements
    ...
    /**
     * Called when the grant was able to grab the code and it wants to exchange it for an access
     * token.
     */
