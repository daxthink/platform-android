package com.ushahidi.android.data.api.heimdalldroid.grants;


import com.ushahidi.android.data.api.heimdalldroid.OAuth2AccessToken;

/**
 * Class representing the Resource Owner Password Credentials Grant as described in
 * https://tools.ietf.org/html/rfc6749#section-4.3.
 *
 * @param <TAccessToken> The access token type.
 */
public abstract class OAuth2ResourceOwnerPasswordCredentialsGrant<TAccessToken extends OAuth2AccessToken>
        implements
