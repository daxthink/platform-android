...
import com.ushahidi.android.core.usecase.post.IListPost;

import java.util.List;

/**
 * Fetches Post with GEO data via the API
 *
 * @author Ushahidi Team <team@ushahidi.com>
 */
public interface IFetchGeoJson extends IInteractor {
    ...
    interface Callback {
        ...
        void onGeoJsonFetched(GeoJson geoJson);
